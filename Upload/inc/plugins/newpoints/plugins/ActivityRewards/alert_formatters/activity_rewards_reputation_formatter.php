...
/***************************************************************************
 *
 *    NewPoints plugin (/inc/plugins/newpoints/plugins/ActivityRewards/alert_formatters/activity_rewards_reputation_formatter.php)
 *    Author: Pirata Nervo
...
class newpoints_activity_rewards_reputation_formatter extends MybbStuff_MyAlerts_Formatter_AbstractFormatter
{
    ...
    public function formatAlert(MybbStuff_MyAlerts_Entity_Alert $alert, array $outputAlert): string
    {
        ...
        return $this->lang->newpoints_alert_text_activity_rewards_reputation;
    }
